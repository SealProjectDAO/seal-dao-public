/* @ts-self-types="./seal_dao_wasm.d.ts" */
 ...
 * @returns {string}
 */
export function generate_keypair(testnet) {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.generate_keypair(testnet);
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
 ...
 * @returns {string}
 */
export function import_from_hex(seed_hex, testnet) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(seed_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.import_from_hex(ptr0, len0, testnet);
        var ptr2 = ret[0];
        var len2 = ret[1];
        if (ret[3]) {
            ptr2 = 0; len2 = 0;
 ...
 * @returns {string}
 */
export function import_from_mnemonic(words, testnet) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(words, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.import_from_mnemonic(ptr0, len0, testnet);
        var ptr2 = ret[0];
        var len2 = ret[1];
        if (ret[3]) {
            ptr2 = 0; len2 = 0;
 ...
 * @returns {Uint8Array}
 */
export function sign(signing_key_bytes, message) {
 ...
 * @returns {string}
 */
export function sql_parse(sql) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(sql, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.sql_parse(ptr0, len0);
        var ptr2 = ret[0];
        var len2 = ret[1];
        if (ret[3]) {
            ptr2 = 0; len2 = 0;
 ...
 * @param {Uint8Array} verifying_key_bytes
 * @param {Uint8Array} message
 * @param {Uint8Array} signature_bytes
 * @returns {boolean}
 */
export function verify(verifying_key_bytes, message, signature_bytes) {
    const ptr0 = passArray8ToWasm0(verifying_key_bytes, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray8ToWasm0(message, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('seal_dao_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
